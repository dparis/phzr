...
(defn get-random-item-
  ...
  Parameters:
    * array-utils (Phaser.ArrayUtils) - Targeted instance for method
...
(defn number-array
  ...
  ([array-utils start end]
   (phaser->clj
    (.numberArray array-utils
                  (clj->phaser start)
                  (clj->phaser end)))))
...
(defn number-array-step
  ...
  ([array-utils start end]
   (phaser->clj
    (.numberArrayStep array-utils
                      (clj->phaser start)
                      (clj->phaser end))))
  ([array-utils start end step]
   (phaser->clj
    (.numberArrayStep array-utils
                      (clj->phaser start)
                      (clj->phaser end)
